                                ...
                                {filteredItems.map((item) => {
                                    ...
                                    return (
                                        <motion.div
                                            ...
                                            className="group bg-gradient-to-b from-white/[0.04] to-white/[0.01] backdrop-blur-xl shadow-[0_0_30px_rgba(99,102,241,0.08)] hover:bg-white/[0.03] border border-white/5 hover:border-indigo-500/20 rounded-2xl p-5 flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-6 transition-all cursor-pointer relative overflow-hidden shadow-2xl"
                                        >
                                            ...
                                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 bg-gradient-to-b from-white/[0.04] to-white/[0.01] backdrop-blur-xl shadow-[0_0_30px_rgba(99,102,241,0.08)] border border-white/5 p-3 rounded-xl min-w-full lg:min-w-[460px] font-mono text-xs">
                                                <div>
