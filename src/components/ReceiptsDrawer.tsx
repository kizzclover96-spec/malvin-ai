...
import { X, Calendar, Clock, DollarSign, QrCode } from 'lucide-react';
              ...
              {sortedReceipts.length === 0 ? (
                ...
                sortedReceipts.map((receipt) => {
                  ...
                  return (
                    <div 
                      key={receipt.id} 
                      className="bg-neutral-50/50 border border-neutral-200/60 rounded-2xl p-4 flex flex-col gap-3 shadow-[0_4px_16px_rgba(0,0,0,0.01)] hover:border-neutral-300 transition-colors"
                    >
                      {/* Top Info Header */}
